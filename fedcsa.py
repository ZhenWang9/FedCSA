...
if __name__ == '__main__':
    ...
    if args.dataset == 'mnist':
        ...
        if args.iid:
            ...
            # dict_users = mnist_iid_static(dataset_train, args.num_users)
        else:
            dict_users = mnist_noniid(dataset_train, args.num_users)
            # dict_users = mnist_noniid_a(dataset_train, args.num_users)
        ...
        # dataset_train = datasets.CelebA('../data/fmnist/', train=True, download=True, transform=trans_mnist)
        ...
        if args.iid:
            ...
            # dict_users = mnist_noniid(dataset_train, args.num_users)
            # dict_users = mnist_noniid_two(dataset_train, args.num_users)
            dict_users = mnist_noniid(dataset_train, args.num_users)
    else:
    ...
    # targe = difference_model_two_middle(w_locals)


    # targe = difference_model_middle(w_locals)
    targe = difference_model_middle_midu(w_locals)
